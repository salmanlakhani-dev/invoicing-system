 ...
 */
export function compileInvoiceHTML({ invoice, company, customer, config = {} }) {
  ...
  return `
    ...
    <body>
      ...
      <div class="header">
        <div>
          ${company.logoUrl ? `
            <img src="${company.logoUrl}" style="height: 48px; max-width: 200px; object-fit: contain; margin-bottom: 12px; display: block;" />
          ` : `
