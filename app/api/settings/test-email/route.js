...
export async function POST(req) {
  try {
    ...
    const mailOptions = {
      ...
      to: testRecipient,
      subject: "🧾 Elevate TM Invoicing SMTP Connection Test",
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #E5E7EB; border-radius: 12px; background-color: #FFFFFF;">
          ...
          <div style="padding: 20px; color: #1A1A2E; line-height: 1.5;">
            <p>Hello,</p>
            <p>Your SMTP mail configurations were tested successfully! Elevate TM Invoicing is now configured to send emails using your custom credentials.</p>
          ...
          <div style="border-top: 1px solid #E5E7EB; padding-top: 15px; font-size: 11px; color: #6B7280; text-align: center;">
            Sent automatically by Elevate TM Invoicing SMTP Diagnostic Panel.
          </div>
        </div>
      `,
    };
